...
enum {
	...
	CHAR_WORK_DIEACT		= CHAR_NPCWORKINT2,	/* 韶氏分凜升丹允月井 */
	...
	CHAR_WORK_BASEIMGBAK	= CHAR_NPCWORKINT8, /* 手午及  颶  寞 */
	CHAR_WORK_DIETIME		= CHAR_NPCWORKINT9, /* 韶氏分凜棉 */
	CHAR_WORK_REVIVALTIME	= CHAR_NPCWORKINT10, /* 戲五忒月凜棉 */
