...
int all_nosee = 0;		/* ㄠ及凜｛蟈化及襯毛 no_see 卞 */
int all_nobody = 0;		/* ㄠ及凜｛蟈化及襯毛 no_body 卞 */
int one_loop_born = 1;	/* ㄠ伙□皿匹  嫖戲心請允醒 oneloop_born */

/*------------------------------------------------------------
 * 襯毛丹心分允樺赭毛瑁爛允月
 * 婁醒
 *  cr      NPC_Create*         甄  及汔互瑁勻化中月NPC_Create及禾奶件正
 *  nobody  int                 1 及凜反簿手中卅中凜卞勾仁月
 *                                          (簿井中化手綜月)
 *                              0 及凜反簿手中卅中凜反綜日卅中〔
 *                                          (簿井中凶凜及心綜月)
 *  nosee   int                 1 及凜反皿伊奶乩□及骰釵及  匹手綜月〔
 *                              0 及凜反皿伊奶乩□及骰釵及陸匹綜月〔
 *  point   NPC_searchPoint*    請蜇今六月樺赭毛醫  允月
...
void NPC_generateLoop( BOOL checkall )
{
    ...
    int    CreateOk=0;
    int enemynum ;
    static int  createcount = 0;        /* create及窒    井日藺爵允月井 */
