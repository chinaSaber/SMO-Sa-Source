...
#define OK     0
#define TCPSTRUCT_ENOMEM -1       /* malloc 失   */
#define TCPSTRUCT_ESOCK -2        /* socket 失   */
#define TCPSTRUCT_EBIND -3        /* bind 失   */
#define TCPSTRUCT_ELISTEN -4      /* listen 失   */
#define TCPSTRUCT_EBUG -6         /* バグである */
#define TCPSTRUCT_EINVCIND -7     /* conへのindexが恭かしいよ */
#define TCPSTRUCT_EREADFIN -8     /* read するデータがなくて closed by remote */
#define TCPSTRUCT_EHOST -9        /* gethostbyname 失   */
#define TCPSTRUCT_ECONNECT -10    /* connect 失   */
#define TCPSTRUCT_ECFULL -11      /* con がいっぱい */
#define TCPSTRUCT_ETOOLONG -12    /* 行がながすぎ */
#define TCPSTRUCT_EMBFULL -13     /* mb がいっぱい  */
#define TCPSTRUCT_ECLOSEAGAIN -14 /* close が2回された */
